...
void Init(struct android_app* app)
{
    ...
    io.Fonts->AddFontFromMemoryTTF(Mono, sizeof(Mono), 22.0f, &font_cfg, io.Fonts->GetGlyphRangesChineseFull());
    io.Fonts->AddFontFromMemoryTTF((void*)icomoon, sizeof(icomoon), 28.0f);
